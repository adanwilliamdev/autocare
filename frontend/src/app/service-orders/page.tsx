...
// (ServiceOrderService.assertCanAccessOrder). A listagem completa continua
// restrita a ADMIN/MANAGER/RECEPTIONIST — um MECHANIC autenticado acessa esta
// rota, mas a listagem geral retorna 403 para esse papel.
export default function ServiceOrdersPage() {
  return (
    <AuthGuard allowedRoles={["ADMIN", "MANAGER", "RECEPTIONIST", "MECHANIC"]}>
