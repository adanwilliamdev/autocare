...
// Orçamentos: criação/consulta por ADMIN/RECEPTIONIST/MANAGER; aprovar é ADMIN/MANAGER
// (mesma regra do BudgetController do backend).
export default function BudgetsPage() {
  return (
    <AuthGuard allowedRoles={["ADMIN", "RECEPTIONIST", "MANAGER"]}>
      <BudgetsPageContent />
    </AuthGuard>
  )
}
